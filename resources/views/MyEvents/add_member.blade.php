                ...
                <div class="addmemberform">
                    <div style="border:1px solid black; border-radius: 10px;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-7"><select class="form-select" id="role" name="role" onclick="Checking();">
                        ...
                        <div class="row">
                            ...
                            <div class="col-7">
                                <select class="form-select" id="department" name="department" style="display: none">
                                    <option>Select department</option>
                                    <option>Secretary</option>
                                    <option>Treasurer</option>
                                    <option>Sponsorship</option>
                                </select>
                                <select class="form-select" id="department2" name="department2" style="display: inline-block">
                                    <option>Select department</option>
