    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4"> 
                                        ...
                                        @csrf 
                                            <div class="row">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Insert title here..." name="title1" aria-label="title1" aria-describedby="basic-addon1">
                                    ...
                                    <div class="card-header" style="background-color: #B7E6A9">
                                        ...
                                        <form action="/events/todo_list/add-InProgress" method="post">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control" placeholder="Insert title here..." aria-label="title2" name="title2" aria-describedby="basic-addon2">
                                                <div class="input-group-append">
                                                    <button class="btn btn-outline-secondary btn-info" type="submit" style="color: white;width:5rem">Add</button>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card-header" style="background-color: #B7E6A9">
                                        ...
                                        <form action="/events/todo_list/add-Completed" method="post">
                                            ...
                                            <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="title3" placeholder="Insert title here..." aria-label="title3" aria-describedby="basic-addon3">
                                                    <div class="input-group-append">
                                                        <button class="btn btn-outline-secondary btn-info" type="submit" style="color: white;width:5rem">Add</button>
                                                    </div>
                                            </div>
            ...
            <div class="row mr-3">
                <div class="col d-flex justify-content-end">
                    <a href="/events/todo_list/todo_list/{{$id}}/{{$pid}}"><button type="button" class="btn btn-primary mr-2">Back</button></a>
                </div>
            </div>
    </main>
    @endsection  
